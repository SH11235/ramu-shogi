...
|------|-------|-------|---------|-----|----------|----------|
| hirate-like | 21 | 1,000,037 | 2,660 | 375,953 | 99 | 3g3f |
| complex-middle | 14 | 1,000,080 | 2,629 | 380,403 | 196 | 8d7d |
| tactical | 14 | 1,000,046 | 2,568 | 389,426 | 290 | N*6d |
| movegen-heavy | 17 | 1,000,097 | 2,748 | 363,936 | 374 | N*2c |

---

## Material 評価時（NNUE 無効）

計測日: 2026-03-27T16:37:04Z
計測コマンド:
...
| 局面 | depth | nodes | time_ms | nps | hashfull | bestmove |
|------|-------|-------|---------|-----|----------|----------|
| hirate-like | 17 | 1,000,055 | 2,706 | 369,569 | 104 | 2h2f |
| complex-middle | 15 | 1,000,175 | 2,466 | 405,585 | 211 | 8d7d |
| tactical | 14 | 1,000,190 | 2,411 | 414,844 | 299 | S*6a |
| movegen-heavy | 15 | 1,000,053 | 2,445 | 409,019 | 401 | G*3c |
...
| 2026-03-27 | 377,204 | 399,048 | **定期計測**（mainブランチ）。NNUE SIMD最適化によりNNUE NPS大幅向上（125,555→377,204、**+200%**）。MaterialのNPS 94%まで迫る。Material: 456,701→399,048（**-12.6%**） |
